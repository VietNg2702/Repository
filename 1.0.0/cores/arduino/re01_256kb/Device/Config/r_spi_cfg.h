...
#define SPI0_TRANSMIT_CONTROL   SPI_USED_DMAC0     ///< SPI0 transmit control
 ...
 *********************************************************************************************************************/
/* @{ */
#define SPI_CFG_ARM_SPI_GET_VERSION      (SYSTEM_SECTION_RAM_FUNC)    //< ARM_SPI_GetVersion() section
#define SPI_CFG_ARM_SPI_GET_CAPABILITIES (SYSTEM_SECTION_RAM_FUNC)    //< ARM_SPI_GetCapabilities() section
#define SPI_CFG_ARM_SPI_INITIALIZE       (SYSTEM_SECTION_RAM_FUNC)    //< ARM_SPI_Initialize() section
#define SPI_CFG_ARM_SPI_UNINITIALIZE     (SYSTEM_SECTION_RAM_FUNC)    //< ARM_SPI_Uninitialize() section
#define SPI_CFG_ARM_SPI_POWERCONTROL     (SYSTEM_SECTION_RAM_FUNC)    //< ARM_SPI_PowerControl() section
#define SPI_CFG_ARM_SPI_SEND             (SYSTEM_SECTION_RAM_FUNC)    //< ARM_SPI_Send() section
#define SPI_CFG_ARM_SPI_RECEIVE          (SYSTEM_SECTION_RAM_FUNC)    //< ARM_SPI_Receive() section
#define SPI_CFG_ARM_SPI_TRANSFER         (SYSTEM_SECTION_RAM_FUNC)    //< ARM_SPI_Transfer() section
#define SPI_CFG_ARM_SPI_GET_DATACOUNT    (SYSTEM_SECTION_RAM_FUNC)    //< ARM_SPI_GetDataCount() section
#define SPI_CFG_ARM_SPI_CONTROL          (SYSTEM_SECTION_RAM_FUNC)    //< ARM_SPI_Control() section
#define SPI_CFG_ARM_SPI_GET_STATUS       (SYSTEM_SECTION_RAM_FUNC)    //< ARM_SPI_GetStatus() section
