...
***********************************************************************************************************************/
/*******************************************************************************************************************//**
 * @brief Stack memory configurations
 **********************************************************************************************************************/
#define SYSTEM_CFG_STACK_MAIN_BYTES         (0x1000) /* This option does not support yet. */
                                                     /* Please change linker script file to change Stack size. */
/*******************************************************************************************************************//**
 * @brief Process stack size in bytes
 **********************************************************************************************************************/
#define SYSTEM_CFG_STACK_PROCESS_BYTES      (0)      /* This option does not support yet. */
                                                     /* Please change linker script file to change Stack size. */
/*******************************************************************************************************************//**
 * @brief Heap memory configurations
 **********************************************************************************************************************/
#define SYSTEM_CFG_HEAP_BYTES               (0x400)  /* This option does not support yet. */
                                                     /* Please change linker script file to change Heap size. */
/*******************************************************************************************************************//**
...
#define SYSTEM_CFG_EVENT_NUMBER_AGT1_AGTI           (SYSTEM_IRQ_EVENT_NUMBER8)  /*!< Numbers 0/4/8/12/16/20/24/28 only */
...
#define SYSTEM_CFG_EVENT_NUMBER_PORT_IRQ8           (SYSTEM_IRQ_EVENT_NUMBER8)  /*!< Numbers 0/8/16/24 only */
#define SYSTEM_CFG_EVENT_NUMBER_PORT_IRQ4           (SYSTEM_IRQ_EVENT_NUMBER4)  /*!< Numbers 4/12/20/28 only */
...
#define SYSTEM_CFG_EVENT_NUMBER_SPI0_SPII           (SYSTEM_IRQ_EVENT_NUMBER2)  /*!< Numbers 2/6/10/14/18/22/26/30 only */
...
#define SYSTEM_CFG_EVENT_NUMBER_PORT_IRQ9           (SYSTEM_IRQ_EVENT_NUMBER26)  /*!< Numbers 2/10/18/26 only */
 ...
 **********************************************************************************************************************/
/* @{ */
#define SYSTEM_CFG_EVENT_NUMBER_PORT_IRQ3           (SYSTEM_IRQ_EVENT_NUMBER3)  /*!< Numbers 3/7/11/15/19/23/27/31 only */
...
#define SYSTEM_CFG_EVENT_NUMBER_PORT_IRQ7           (SYSTEM_IRQ_EVENT_NUMBER7)  /*!< Numbers 7/15/23/31 only */
