...
#define SMIP_CFG_VCOM_PORT                  (PORT8)         /*!< Select VCOM port */
#define SMIP_CFG_VCOM_PIN                   (14)             /*!< Select VCOM pin */
#define SMIP_CFG_SCS_PORT                   (PORT0)         /*!< Select SCS port */
#define SMIP_CFG_SCS_PIN                    (15)             /*!< Select SCS pin */
#define SMIP_CFG_RST_DISP_PORT              (PORT8)         /*!< Select RST/DISP port */
#define SMIP_CFG_RST_DISP_PIN               (13)             /*!< Select RST/DISP pin */

#define SMIP_CFG_MAKE_LINE_INFO             (0)             /*!< Select sending data  @n
...
#define SMIP_CFG_SPI_BIT_ORDER              (1)             /*!< Select SPI communication bit order setting @n
                                                                  0 : MSB  @n
                                                                  1 : LSB  */
 ...
 *********************************************************************************************************************/
/* @{ */
#define SMIP_CFG_SECTION_R_SMIP_GETVERSION          (SYSTEM_SECTION_RAM_FUNC)       /*!<  R_SMIP_GetVersion() section */
#define SMIP_CFG_SECTION_R_SMIP_OPEN                (SYSTEM_SECTION_RAM_FUNC)       /*!<  R_SMIP_Open() section */
#define SMIP_CFG_SECTION_R_SMIP_CLOSE               (SYSTEM_SECTION_RAM_FUNC)       /*!<  R_SMIP_Close() section */
#define SMIP_CFG_SECTION_R_SMIP_POWER_ON            (SYSTEM_SECTION_RAM_FUNC)       /*!<  R_SMIP_PowerOn() section */
#define SMIP_CFG_SECTION_R_SMIP_POWER_OFF           (SYSTEM_SECTION_RAM_FUNC)       /*!<  R_SMIP_PowerOff() section */
#define SMIP_CFG_SECTION_R_SMIP_ALL_ZERO            (SYSTEM_SECTION_RAM_FUNC)       /*!<  R_SMIP_AllZero() section */
#define SMIP_CFG_SECTION_R_SMIP_ALL_ONE             (SYSTEM_SECTION_RAM_FUNC)       /*!<  R_SMIP_AllOne() section */
#define SMIP_CFG_SECTION_R_SMIP_SEND                (SYSTEM_SECTION_RAM_FUNC)       /*!<  R_SMIP_Send() section */
#define SMIP_CFG_SECTION_R_SMIP_SEND_COLOR          (SYSTEM_SECTION_RAM_FUNC)       /*!<  R_SMIP_SendColor() section */
#define SMIP_CFG_SECTION_R_SMIP_SEND_COMMAND        (SYSTEM_SECTION_RAM_FUNC)       /*!<  R_SMIP_SendCommand() section */
#define SMIP_CFG_SECTION_R_SMIP_SUSPEND             (SYSTEM_SECTION_RAM_FUNC)       /*!<  R_SMIP_Suspend() section */
#define SMIP_CFG_SECTION_R_SMIP_RESUME              (SYSTEM_SECTION_RAM_FUNC)       /*!<  R_SMIP_Resume() section */
#define SMIP_CFG_SECTION_R_SMIP_RECONFIG_SPI_SPPED  (SYSTEM_SECTION_RAM_FUNC)       /*!<  R_SMIP_ResetSpiSpeed() section */
