...
#define FWUP_SIGNATURE_SHA256           1   // SHA256.
...
#else
#error "Illegal combination. Check the CFG value of r_fwup_cfg.h"
#endif
...
#ifdef BSP_MCU_SERIES_RX600
/* R_FWUP_Write() arguments: specify "low address" and process to "high address" */
...
#define BOOT_LOADER_LOW_ADDRESS FLASH_CF_BLOCK_0
#define BOOT_LOADER_MIRROR_LOW_ADDRESS FLASH_CF_BLOCK_51
...
#define SCI_INTERRUPT_PRIORITY 0    /* 0(low) - 15(high) */

// #define FLASH_INTERRUPT_PRIORITY configMAX_SYSCALL_INTERRUPT_PRIORITY    /* 0(low) - 15(high) */
#if (FLASH_CFG_CODE_FLASH_RUN_FROM_ROM == 1)
#define BOOT_LOADER_UPDATE_TEMPORARY_AREA_LOW_ADDRESS FLASH_CF_BLOCK_256
#define BOOT_LOADER_UPDATE_EXECUTE_AREA_LOW_ADDRESS FLASH_CF_BLOCK_128
#define BOOT_LOADER_UPDATE_TARGET_BLOCK_NUMBER (128)
#else /* (FLASH_CFG_CODE_FLASH_RUN_FROM_ROM == 1) */
#define BOOT_LOADER_UPDATE_TEMPORARY_AREA_LOW_ADDRESS FLASH_CF_BLOCK_40
#define BOOT_LOADER_UPDATE_EXECUTE_AREA_LOW_ADDRESS FLASH_CF_BLOCK_16
#define BOOT_LOADER_UPDATE_TARGET_BLOCK_NUMBER (24)
#endif /* (FLASH_CFG_CODE_FLASH_RUN_FROM_ROM == 1) */
#define USER_RESET_VECTOR_ADDRESS (BOOT_LOADER_UPDATE_EXECUTE_AREA_LOW_ADDRESS + 0x304)
#define USER_MSP_VECTOR_ADDRESS (BOOT_LOADER_UPDATE_EXECUTE_AREA_LOW_ADDRESS + 0x300)
#define BOOT_LOADER_USER_FIRMWARE_HEADER_LENGTH 0x200
#define BOOT_LOADER_USER_FIRMWARE_DESCRIPTOR_LENGTH 0x100
#define BOOT_LOADER_TOTAL_UPDATE_SIZE   (uint32_t)(BOOT_LOADER_UPDATE_TARGET_BLOCK_NUMBER * FLASH_CF_BLOCK_SIZE)
...
#define MONITORING_STATUS_COUNT     (60000)
...
#else /* #if(BSP_MCU_SERIES_RX600) */
#define FWUP_WRITE_BLOCK_SIZE       (4096)
...
typedef enum e_fwup_state
{
    ...
    FWUP_STATE_BANK1_UPDATE_CODE_FLASH_ERASE_WAIT,
    FWUP_STATE_BANK1_UPDATE_CODE_FLASH_ERASE_COMPLETE,
    FWUP_STATE_BANK1_UPDATE_CODE_FLASH_ERASE_WAIT2,     
    FWUP_STATE_BANK1_UPDATE_CODE_FLASH_ERASE_COMPLETE2, 
    FWUP_STATE_BANK0_UPDATE_CODE_FLASH_ERASE_WAIT,      
    FWUP_STATE_BANK0_UPDATE_CODE_FLASH_ERASE_COMPLETE,  
    FWUP_STATE_BANK0_UPDATE_CODE_FLASH_WRITE_WAIT,      
    FWUP_STATE_BANK0_UPDATE_CODE_FLASH_WRITE_COMPLETE,  
#if BSP_MCU_SERIES_RX600
    FWUP_STATE_EOL_BANK1_ERASE_WAIT,
    FWUP_STATE_EOL_BANK1_ERASE_COMPLETE,
    FWUP_STATE_EOL_BANK1_LIFECYCLE_WRITE_WAIT,
    ...
    FWUP_STATE_EOL_DATA_FLASH_ERASE_COMPLETE,
#else
    FWUP_STATE_EOL_BANK0_ERASE_WAIT,
    FWUP_STATE_EOL_BANK0_ERASE_COMPLETE,
    FWUP_STATE_EOL_BANK0_LIFECYCLE_WRITE_WAIT,
    FWUP_STATE_EOL_BANK0_LIFECYCLE_WRITE_COMPLETE,
    FWUP_STATE_EOL_ERASE_COMPLETE,
...
Public Functions
******************************************************************************/
#if (FWUP_CFG_SECTION_R_FWUP_OPEN == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_OPEN          __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_OPEN
#endif
#if (FWUP_CFG_SECTION_R_FWUP_CLOSE == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_CLOSE         __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_CLOSE
#endif
#if (FWUP_CFG_SECTION_R_FWUP_OPERATION == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_OPERATION         __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_OPERATION
#endif
#if (FWUP_CFG_SECTION_R_FWUP_SET_END_OF_LIFE == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_SET_END_OF_LIFE         __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_SET_END_OF_LIFE
#endif
#if (FWUP_CFG_SECTION_R_FWUP_SOFTWARE_RESET  == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_SOFTWARE_RESET    __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_SOFTWARE_RESET
#endif
#if (FWUP_CFG_SECTION_R_FWUP_CREATE_FILE_FOR_RX == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_CREATE_FILE_FOR_RX    __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_CREATE_FILE_FOR_RX
#endif
#if (FWUP_CFG_SECTION_R_FWUP_ABOUT == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_ABOUT    __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_ABOUT
#endif
#if (FWUP_CFG_SECTION_R_FWUP_WRITE_BLOCK == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_WRITE_BLOCK    __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_WRITE_BLOCK
#endif
#if (FWUP_CFG_SECTION_R_FWUP_CLOSE_FILE == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_CLOSE_FILE    __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_CLOSE_FILE
#endif
#if (FWUP_CFG_SECTION_R_FWUP_CHECK_FILE_SIGNATURE == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_CHECK_FILE_SIGNATURE    __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_CHECK_FILE_SIGNATURE
#endif
#if (FWUP_CFG_SECTION_R_FWUP_READ_AND_ASSUME == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_READ_AND_ASSUME    __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_READ_AND_ASSUME
#endif
#if (FWUP_CFG_SECTION_R_FWUP_RESET_DEVICE == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_RESET_DEVICE    __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_RESET_DEVICE
#endif
#if (FWUP_CFG_SECTION_R_FWUP_ACTIVATE_NEWIMAGE == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_ACTIVATE_NEWIMAGE    __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_ACTIVATE_NEWIMAGE
#endif
#if (FWUP_CFG_SECTION_R_FWUP_SET_PLATFORM == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_SET_PLATFORM    __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_SET_PLATFORM
#endif
#if (FWUP_CFG_SECTION_R_FWUP_GET_PLATFORM == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_GET_PLATFORM    __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_GET_PLATFORM
#endif
#if (FWUP_CFG_SECTION_R_FWUP_GET_VERSION == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_GET_VERSION    __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_GET_VERSION
#endif
#if (FWUP_CFG_SECTION_R_FWUP_SECURE_BOOT == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_SECURE_BOOT    __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_SECURE_BOOT
#endif
#if (FWUP_CFG_SECTION_R_FWUP_EXECUTE_FIRMWARE == SYSTEM_SECTION_RAM_FUNC)
#define FUNC_LOCATION_R_FWUP_EXECUTE_FIRMWARE    __attribute__ ((section(".ramfunc"))) /* @suppress("Macro expansion") */
#else
#define FUNC_LOCATION_R_FWUP_EXECUTE_FIRMWARE
#endif


#if (FWUP_CFG_IMPLEMENTATION_ENVIRONMENT == 0)  /* Bootloader */
fwup_err_t R_FWUP_SecureBoot(void)                                    FUNC_LOCATION_R_FWUP_SECURE_BOOT;
void R_FWUP_ExecuteFirmware(void)                                  FUNC_LOCATION_R_FWUP_EXECUTE_FIRMWARE;
#elif (FWUP_CFG_IMPLEMENTATION_ENVIRONMENT == 1)  /* Firmware update w/o OS */
fwup_err_t R_FWUP_Open(void)                                       FUNC_LOCATION_R_FWUP_OPEN;
fwup_err_t R_FWUP_Close(void)                                      FUNC_LOCATION_R_FWUP_CLOSE;
fwup_err_t R_FWUP_Operation(void)                                  FUNC_LOCATION_R_FWUP_OPERATION;
fwup_err_t R_FWUP_SetEndOfLife(void)                               FUNC_LOCATION_R_FWUP_SET_END_OF_LIFE;
void R_FWUP_SoftwareReset(void)                                    FUNC_LOCATION_R_FWUP_SOFTWARE_RESET;
#elif (FWUP_CFG_IMPLEMENTATION_ENVIRONMENT == 2)  /* Firmware update with Amazon FreeRTOS(OTA) */
OTA_Err_t R_FWUP_CreateFileForRx( OTA_FileContext_t * const C )    FUNC_LOCATION_R_FWUP_CREATE_FILE_FOR_RX;
OTA_Err_t R_FWUP_Abort( OTA_FileContext_t * const C )              FUNC_LOCATION_R_FWUP_ABOUT;
int16_t R_FWUP_WriteBlock( OTA_FileContext_t * const C, uint32_t ulOffset, uint8_t * const pacData, uint32_t ulBlockSize ) FUNC_LOCATION_R_FWUP_WRITE_BLOCK;
OTA_Err_t R_FWUP_CloseFile( OTA_FileContext_t * const C )          FUNC_LOCATION_R_FWUP_CLOSE_FILE;
OTA_Err_t R_FWUP_CheckFileSignature( OTA_FileContext_t * const C ) FUNC_LOCATION_R_FWUP_CHECK_FILE_SIGNATURE;
uint8_t * R_FWUP_ReadAndAssumeCertificate( const uint8_t * const pucCertName, uint32_t * const ulSignerCertSize ) FUNC_LOCATION_R_FWUP_READ_AND_ASSUME;
OTA_Err_t R_FWUP_ResetDevice( void )                               FUNC_LOCATION_R_FWUP_RESET_DEVICE;
OTA_Err_t R_FWUP_ActivateNewImage( void )                          FUNC_LOCATION_R_FWUP_ACTIVATE_NEWIMAGE;
OTA_Err_t R_FWUP_SetPlatformImageState( OTA_ImageState_t eState )  FUNC_LOCATION_R_FWUP_SET_PLATFORM;
OTA_PAL_ImageState_t R_FWUP_GetPlatformImageState( void )          FUNC_LOCATION_R_FWUP_GET_PLATFORM;
OTA_Err_t R_FWUP_GetVersion(void)                                  FUNC_LOCATION_R_FWUP_GET_VERSION;
#endif
