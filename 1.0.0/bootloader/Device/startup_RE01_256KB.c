 ...
 **********************************************************************************************************************/
/***********************************************************************************************************************
 * File Name    : startup_RE01_256KB.c
 * Version      : 0.40
 * Description  : CMSIS Cortex-M# Core Device Startup File for Device <RE01_256KB>
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
#if defined(__GNUC__)                    /* GCC Compiler */
#define SYSTEM_CFG_STACK_SIZE  (0x1000)   /* @suppress("Internal macro naming") */ /* @suppress("Non-block comment") */
...
/* End of file (startup_RE01_256KB.c) */
