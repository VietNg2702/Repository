#ifndef _LR1110_USER_CONFIG_MODE_H
#define _LR1110_USER_CONFIG_MODE_H


#define TRACKER_TX (0)  // Selector 1 .. TX Mode  0 .. RX Mode

#define SEND_TO_SERVER (0) // // Selector 1 ..  SEND GNSS data to SERVER  0 .. Dont Send
...
#define TX_BOARD_VERSION     (2)    //  Version1 .. LR1110 and accelerator always ON    
